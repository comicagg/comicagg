...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=comics.fields.AltTextField(blank=True, null=True, verbose_name='Last image alt text'),
        ),
        migrations.AlterField(
            model_name='comic',
            name='last_update',
        ...
        migrations.AlterField(
            model_name='comic',
            name='name',
            field=comics.fields.ComicNameField(max_length=255, verbose_name='Name'),
        ),
        migrations.AlterField(
            model_name='comic',
            name='notify',
        ...
        migrations.AlterField(
            ...
            name='alt_text',
            field=comics.fields.AltTextField(blank=True, null=True, verbose_name='Alternative text'),
        ),
    ]
