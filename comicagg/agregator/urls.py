...
urlpatterns = patterns('comicagg.agregator.views',
	...
	url(r'^ajax/configure/quickforget/$', 'forget_new_comics', name='forget_new_comics_quick', kwargs={'quick':True}),
	url(r'^ajax/configure/forget/(?P<comic_id>\d+)/$', 'forget_new_comic', name='forget_new_comic'),
	url(r'^ajax/configure/save/$', 'save_selection', name='save_selection'),
