...
urlpatterns = patterns('comic_ak.agregator.views',
    ...
    url(r'^comic_list/$', 'comic_list', name='comic_list'),
    url(r'^comic_list/(?P<sortby>\w+)/$', 'comic_list', name='comic_list_sorted'),
    url(r'^comic_list/tag/(?P<tag>[^/]+)/$', 'comic_list', name='view_tag'),
    url(r'^comic_list/tag/(?P<tag>[^/]+)/(?P<sortby>\w+)/$', 'comic_list', name='view_tag_sorted'),
